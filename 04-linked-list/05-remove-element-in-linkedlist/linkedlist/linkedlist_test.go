...
import (
	"testing"
	"Play-with-Data-Structures/04-linked-list/05-remove-element-in-linkedlist/linkedlist"
)
...
func TestLinkedList_Remove(t *testing.T) {
	...
	linked.PrintIn()
	if v, err := linked.Remove(1); err != nil{
		t.Error(err)
	}else{
		t.Logf("linkedlist v: %+v\n",v)
	}
	linked.PrintIn()
}
...
func TestLinkedList_RemoveFirst(t *testing.T) {
	...
	if first, err := linked.RemoveFirst(); err != nil{
		t.Error(err)
	}else{
		t.Logf("linkedlist first: %+v \n",first)
	}
	linked.PrintIn()
}
...
func TestLinkedList_RemoveLast(t *testing.T) {
	...
	linked.PrintIn()
	if last, err := linked.RemoveLast();err != nil{
		t.Error(err)
	}else{
		t.Logf("linkedlist last: %+v\n",last)
	}
}
